  ...
  return (
    ...
    >
      <div
        ...
        className="bg-[#F7F5F0] border border-[#DDD6C8] rounded-3xl max-w-2xl w-full shadow-2xl flex flex-col max-h-[90vh] overflow-hidden my-auto animate-in fade-in zoom-in-95 duration-150 cursor-default"
      >
        {/* Header */}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    setFormData({
                      ...formData,
                      category_id: e.target.value ? parseInt(e.target.value, 10) : "",
                    });
                    setTouched((prev) => ({ ...prev, category_id: true }));
                  }}
                  onBlur={() => setTouched((prev) => ({ ...prev, category_id: true }))}
                  className={`w-full bg-[#FFFFFF] border rounded-xl px-3.5 py-2.5 text-sm text-[#2C2A29] focus:outline-none transition shadow-xs cursor-pointer ${
                    finalCategoryError
                      ? "border-red-500 focus:border-red-500 bg-red-50"
                      : "border-[#D8D4CE] focus:border-[#1E3A5F]"
                  }`}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onBlur={() => setTouched((prev) => ({ ...prev, stock_quantity: true }))}
                  placeholder="50"
                  className={`w-full bg-[#FFFFFF] border rounded-xl px-4 py-2.5 text-sm text-[#2C2A29] placeholder-stone-400 focus:outline-none transition shadow-xs ${
                    finalStockError
                      ? "border-red-500 focus:border-red-500 bg-red-50"
